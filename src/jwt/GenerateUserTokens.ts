...
*/
export function generateAccessToken(userID: string, issuer: string, keyArray: string[], validTime: number, options?: any, audience?: string) {
 ...
 * @options this can be used to provide any extra properties that are not "standard" for jwts for your use case. These values will be in the payload of the jwt
*/
export function generateRefreshToken(userID: string, issuer: string, keyArray: string[], validTime: number, options?: any, audience?: string) {
